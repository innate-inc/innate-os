...
| `people_node` (recognizes people; **experimental**, `enabled: true` turns it on at the next reboot) | `enabled` (launch-time only), `allow_model_download`, `tick_hz` | `false`, `true`, `2.0` |
