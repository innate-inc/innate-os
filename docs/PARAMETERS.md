...
| `people_node` (recognition + person memory) | `enabled`, `always_on`, `seek_faces`, `scribe`, `prefer_backend`, `tick_source`, `allow_model_download`, `retention_unnamed_days` / `retention_named_days`, `camera_height_m`, `gemini_model` | `true`, `false`, `false`, `true`, `"opencv"`, `"compressed"`, `true`, `14.0` / `548.0`, `0.26`, see template |
