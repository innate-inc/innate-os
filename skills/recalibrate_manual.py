...
class RecalibrateManual(Skill):
    ...
    def execute(self, corner: str):
        ...
        if calibration is None:
            return "No existing calibration found. Run full board calibration first.", SkillResult.FAILURE
        ...
        if other_key not in calibration:
            return f"Existing calibration missing {other_name} ({other_key}). Cannot recompute.", SkillResult.FAILURE
