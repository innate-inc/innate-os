#!/usr/bin/env python3
"""
Arm Go Up Skill - Move arm up to Z=0.1 while keeping current XY position.
"""
...
class ArmGoUp(Skill):
    ...
    def execute(self, duration: int = 3):
        ...
        self.logger.info(
            f"Moving arm up to Z={self.TARGET_Z} from current XY=({x}, {y})"
        )
        ...
        return f"Arm moved up to Z={self.TARGET_Z}", SkillResult.SUCCESS
