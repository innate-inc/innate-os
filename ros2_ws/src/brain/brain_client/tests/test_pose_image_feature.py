...
class MockNode:
    ...
    def get_parameter(self, name):
        ...
        return MagicMock(get_parameter_value=lambda: MagicMock(
...
mock_elder = MockDirective("elder_safety_directive", ["navigate_to_position", "send_email"], "Elder safety directive")
...
from brain_client.message_types import MessageIn, MessageInType, MessageOut, MessageOutType
