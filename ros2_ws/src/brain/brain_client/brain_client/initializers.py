...
def initialize_primitives(logger, simulator_mode: bool = False) -> Dict[str, Any]:
    ...
    # Using the new unified primitives directory at the root of innate-os
    primitives_directory = os.path.expanduser("~/innate-os/primitives")
...
def initialize_directives(logger, primitives_dict: Optional[Dict[str, Any]] = None) -> Tuple[Dict[str, Any], Optional[Any]]:
    ...
    # Using the unified directives directory at the root of innate-os
    directives_directory = os.path.expanduser("~/innate-os/directives")
