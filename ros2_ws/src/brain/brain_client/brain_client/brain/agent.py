...
if TYPE_CHECKING:
    ...
    from brain_client.brain.llm import LlmRoute
...
class BrainAgent:
    ...
    def _build_tools(self, events: list[Event]) -> list[ToolDefinition]:
        running = self._state.primitive_running
    ...
    def _trace_turn_start(
        self, text: str, frames: list[Frame], tools: list[ToolDefinition], system: str, context: ChatContext
    ) -> None:
