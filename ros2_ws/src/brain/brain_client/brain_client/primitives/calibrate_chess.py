...
class CalibrateChess(Primitive):
    ...
    It now also resets the initial board state.
    """
    ...
    def __init__(self, logger):
        ...
        self.corners_file_path = "/tmp/chess_board_corners.npy"  # Use numpy's native format
    ...
    def execute(self, **kwargs):
        ...
        try:
            # Step 1: Capture and save the initial board image
            ...
            # Step 2: Detect and save corners from the new image
            self._send_feedback("🔍 Detecting chessboard corners from new image")
    ...
    def is_calibrated():
        ...
        """
        corners_file_path = "/tmp/chess_board_corners.npy"  # Use numpy's native format
        return os.path.exists(corners_file_path) 