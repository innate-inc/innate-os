...
def generate_launch_description():
    ...
    rosbridge_node = Node(
        package="rws", executable="rws_server", name="ros_websocket_server", parameters=[{}], output="screen"
    )
    ...
    app_node = Node(
        ...
        name="maurice_app",
        output="screen",
        parameters=[{"data_directory": data_directory, "default_hardware_revision": default_hardware_revision}],
    )
