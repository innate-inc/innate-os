...
def generate_launch_description():
    ...
    disable_auto_exposure_arg = DeclareLaunchArgument(
        "disable_auto_exposure", default_value="false", description="Disable automatic exposure (true/false)"
    )
    ...
    enable_auto_exposure_arg = DeclareLaunchArgument(
        "enable_auto_exposure", default_value="false", description="Enable custom auto exposure algorithm (true/false)"
    )
