...
from maurice_msgs.srv import GotoJS  # Service now includes a float64 time in the request
...
class ArmCommanderNode(Node):
    ...
    def goto_js_callback(self, request, response):
        ...
        Expects:
          ...
          - request.time: a float64 representing the total trajectory time in seconds.
