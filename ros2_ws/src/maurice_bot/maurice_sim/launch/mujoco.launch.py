    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "model_path", default_value=model_path, description="Absolute path to the MJCF file."
            ),
            ...
            Node(package=arm_package_name, executable="arm_utils.py", name="arm_utils_node", output="screen"),
        ]
    )
