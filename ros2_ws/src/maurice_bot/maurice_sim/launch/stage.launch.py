...
def generate_launch_description():
    ...
    gui_arg = DeclareLaunchArgument(
        "enable_gui",
        default_value="false",
        description="Enable Stage GUI window (set true for local dev with display)",
    )
    ...
    # Publish initial pose at (0,0,0) after a short delay so AMCL can seed localization
