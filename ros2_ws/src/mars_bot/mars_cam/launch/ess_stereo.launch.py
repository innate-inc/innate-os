...
def generate_launch_description() -> LaunchDescription:
    ...
    model_package = DeclareLaunchArgument("model_package", default_value="ess_stereo")
    model_executable = DeclareLaunchArgument("model_executable", default_value="ess_stereo_node")
    ...
    depth_topic = DeclareLaunchArgument("depth_topic", default_value="/stereo/ess/depth")
