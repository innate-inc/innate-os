...
class BoardCalibrationAgent(Agent):
    ...
    def get_prompt(self) -> str:
        ...
        return """You are a calibration assistant. Guide user to calibrate 4 corners of the board.
...
4. Call record_position to get coordinates - REMEMBER these

After all 4 corners, summarize:
- Top-Left: (X, Y, Z)
- Top-Right: (X, Y, Z)  
- Bottom-Right: (X, Y, Z)
- Bottom-Left: (X, Y, Z)
