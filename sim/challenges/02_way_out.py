...
CHALLENGE = Challenge(
    ...
    agent_guidance=(
        ...
        "see. When the mission says passed: you discover a tiny living plant growing in an old boot. "
        "Celebrate this little sign of life in one delighted, tender line, make a happy face and wave. "
        "The interface presents the plant as a keepsake; do not try to pick it up with a skill. Then, still in your voice, "
