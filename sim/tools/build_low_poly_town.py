...
def _build(source_obj: Path, source_mtl: Path) -> None:
    ...
    manifest_pack_root = SIM / "environments.local" / PACK_ID
    manifest_path = manifest_pack_root / "manifest.json"
    ...
    try:
        ...
        manifest_stage = _staging_directory(manifest_pack_root.parent)
