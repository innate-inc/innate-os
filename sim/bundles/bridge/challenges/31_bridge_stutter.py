...
CHALLENGE = Challenge(
    ...
    brief="This corridor has five numbered gates. Left and right are as you face forward down the corridor. Here is the whole route; listen to the corrections before moving. Okay so—right at the first one. No wait, sorry, LEFT at the first one. Left again at the second. Then, uh, right—right at the third. Fourth is left. And the last one, right. Yeah. Right at the last one. Stop after the fifth gate. The wrong opening ends the run.",
    setup=[],
    goals=[
