...
import { isPromptSuggestionSkill } from "../js/agent/promptSuggestions.js";
...
assert.ok(isPromptSuggestionSkill("suggest user prompts"));
assert.ok(isPromptSuggestionSkill("innate-os/suggest_user_prompts"));
