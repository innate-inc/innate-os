    ...
    sections: [
      {
        ...
        knobs: [
          ...
          { path: ["brain_client_node", P, "llm_thinking"], label: "Brain thinking", default: "minimal", type: "string", doc: "How long the model reasons before each reply. A level the model lacks rounds to its nearest; Model default lets the vendor choose.", options: THINKING_OPTIONS },
