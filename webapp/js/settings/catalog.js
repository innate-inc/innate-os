    ...
    sections: [
      ...
      },
      {
        ...
        knobs: [
          ...
          { path: ["brain_client_node", P, "llm_thinking"], label: "Thinking", default: "minimal", type: "string", doc: "Sent as reasoning_effort: minimal, low, medium or high. Blank leaves the server's own default.", subsection: "Brain" },
